...
export class VdpConveniosReportComponent implements OnInit {
    ...
    exportToExcel() {
        if (this.foundResults != null && this.foundResults.length > 0)
            this.excelService.generateReportConvenioExcel(this.foundResults, 'ReporteConveniosVDP');
        else
                            ...
                            this.AtpReportService.ProcessReportConvenioVDP(data).subscribe(
                                res => {
                                    ...
                                    if (this.foundResults != null && this.foundResults.length > 0) {
                                        ...
                                        this.excelService.generateReportConvenioExcel(this.foundResults, 'Reporte Convenios VDP -');
                                    }
                                    else {
                                        this.totalItems = 0;
