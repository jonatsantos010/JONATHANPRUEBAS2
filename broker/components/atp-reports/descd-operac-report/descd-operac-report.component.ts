                                ...
                                res => {
                                    ...
                                    if (this.foundResults != null) {
                                        ...
                                        if (this.totalItems > 0) {
                                            if (this.foundResults.reportVig != null && this.foundResults.reportVig.length > 0) {
                                                this.excelService.generateReportOperacVigExcel(this.foundResults.reportVig, 'Reporte PólizasVigentes_');
                                            }

                                            if (this.foundResults.reportAnnul != null && this.foundResults.reportAnnul.length > 0) {
                                                this.excelService.generateReportOperacAnulExcel(this.foundResults.reportAnnul, 'Reporte PólizasAnuladas_');
                                            }
                                        } else {
