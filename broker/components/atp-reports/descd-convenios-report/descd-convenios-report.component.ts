...
export class DescdConveniosReportComponent implements OnInit {
    ...
    exportToExcel() {
        if (this.foundResults != null && this.foundResults.length > 0)
            this.excelService.generateReportConveniosExcel(this.foundResults, 'ReporteConvenios');
        else
                            ...
                            this.AtpReportService.ProcessReportsConvenios(data).subscribe(
                                res => {
                                    ...
                                    if (this.foundResults != null && this.foundResults.length > 0) {
                                        ...
                                        this.excelService.generateReportConveniosExcel(this.foundResults, 'Reporte Convenios -');
                                    }
                                    else {
                                        this.totalItems = 0;
