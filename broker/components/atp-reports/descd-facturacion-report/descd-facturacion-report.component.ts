...
export class DescdFacturacionReportComponent implements OnInit {
    ...
    exportToExcel() {
        if (this.foundResults != null && this.foundResults.length > 0)
            this.excelService.generateReportFacturacionExcel(this.foundResults, 'ReporteFacturacion');
        else
                            ...
                            this.AtpReportService.ProcessReportsFacturacion(data).subscribe(
                                res => {
                                    ...
                                    if (this.foundResults != null && this.foundResults.length > 0) {
                                        ...
                                        this.excelService.generateReportFacturacionExcel(this.foundResults, 'Reporte Facturación -');
                                    }
                                    else {
                                        this.totalItems = 0;
