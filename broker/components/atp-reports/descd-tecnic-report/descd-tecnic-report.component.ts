...
export class DescdTecnicReportComponent implements OnInit {
    ...
    exportToExcel() {
        if (this.foundResults != null && this.foundResults.length > 0)
            this.excelService.generateReportTecnicExcel(this.foundResults, 'ReporteTecnico');
        else
                            ...
                            this.AtpReportService.ProcessReportsTecnic(data).subscribe(
                                res => {
                                    ...
                                    if (this.foundResults != null && this.foundResults.length > 0) {
                                        ...
                                        this.excelService.generateReportTecnicExcel(this.foundResults, 'Reporte Técnico -');
                                    }
                                    else {
                                        this.totalItems = 0;
