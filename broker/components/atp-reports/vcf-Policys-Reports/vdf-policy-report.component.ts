                                    ...
                                    if (this.foundResults != null) {
                                        ...
                                        if (this.totalItems > 0) {
                                            if (this.foundResults.reportVig != null && this.foundResults.reportVig.length > 0) {
                                                this.excelService.generateReportVigExcelVCF(this.foundResults.reportVig, 'PólizasVigentesVCF_');
                                            }

                                            if (this.foundResults.reportAnnul != null && this.foundResults.reportAnnul.length > 0) {
                                                this.excelService.generateReportAnulExcelVCF(this.foundResults.reportAnnul, 'PólizasAnuladasVCF_');
                                            }
                                        } else {
